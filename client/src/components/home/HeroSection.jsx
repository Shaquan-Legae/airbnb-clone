...
export default function HeroSection() {
  return (
    <section className="relative min-h-[560px] overflow-hidden bg-neutral-950 mb-10 rounded-4xl">
      <img
        src={homeImages.hero}
      ...
      <div className="relative mx-auto flex min-h-[560px] max-w-7xl items-center px-5 pb-20 pt-16 lg:px-8">
