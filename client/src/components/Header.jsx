...
export default function Header() {
    ...
    return (
        <header className="flex justify-between items-center">
            ...
            <div className="flex border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 gap-2.5">
                <div>Anywhere</div>
                <div className="border border-l-0 border-gray-300"></div>
                <div>Anyweek</div>
                <div className="border border-l-0 border-gray-300"></div>
                <div>Add guests</div>
            ...
            <Link
                ...
                className="menu flex items-center border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 gap-2.5"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
